...
Connect To DB Servers and Create Employee Table
	[Documentation]		Connect To DB Servers and Create Employee Table	
	[Tags]    DB
	[Setup]		DB Test Setup
...
Execute SQL Script - Insert Data Employee table
	[Documentation]		Execute SQL Script - Insert Data Employee table
    [Tags]    DB    DB_SMOKE
    Log		${EMP_DataSql}
...
Table Must Exist - Employee
	[Documentation]		Table Must Exist - Employee
    [Tags]    DB    DB_SMOKE
    Table Must Exist    Employee
